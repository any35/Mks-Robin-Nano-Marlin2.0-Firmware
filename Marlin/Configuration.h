...
#define STRING_CONFIG_H_AUTHOR "(yehuping_XYZ, MKS Robin Nano V3.1)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { \
    80.4 * X_MICROSTEPS / 16.0, \
    80.4 * Y_MICROSTEPS / 16.0, \
    794 * Z_MICROSTEPS / 16.0, \
    94 * E0_MICROSTEPS / 16.0 \
   }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 3 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -6, -26.9, -3.6  }
...
// 探测时活动的范围(相对于 z pos + NOZZLE_TO_PROBE_OFFSET + Z_CLEARANCE_DEPLOY_PROBE)
// 太小会导致探测提前结束
// 太大可能导致故障时打印头和热床出现碰撞
